...
export default function About() {
    return (
        <div className={`row mb-5 ${AboutStyles.about} `}>
            ...
            <p class={`${AboutStyles.aboutsText}`}>LearnProgramming to platforma edukacyjna, która umożliwia użytkownikom naukę programowania w sposób interaktywny i przyjazny dla użytkownika. Nasza aplikacja oferuje szeroki zakres kursów z różnych dziedzin programowania, takich jak Java, Python, JavaScript, C i wiele innych.</p>
